<template>
  <div class="comp-filters">
    <a-button v-if="tags.length > 0" class="filters" @click="showModal = true">Filtrer par tag</a-button>
    <a-modal v-model="showModal" title="Filtrer les tags" :footer="null">
      <a-input v-model="tagSearched" class="search font" type="text" placeholder="filtrer tags" />
